import svgPaths from "./svg-21b221jm0c";

function BackgroundBorder() {
  return <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[606px] left-[32px] right-[32px] rounded-[10px] top-[342px]" data-name="Background+Border" />;
}

function Background() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#14b2a4] left-[16px] rounded-[33554400px] size-[40px] top-[calc(50%-176.5px)]" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[14px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[14px] text-center text-white top-1/2 w-[9.54px]">
...
function Background1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#d9d9d9] h-[6px] left-[68px] overflow-clip right-[798px] rounded-[33554400px] top-[calc(50%-163.5px)]" data-name="Background">
      <div className="absolute bg-[#14b2a4] bottom-0 left-0 right-3/4 rounded-[33554400px] top-0" data-name="Background" />
    </div>
  );
}
...
function Svg() {
  return (
    <div className="-translate-y-1/2 absolute h-[12px] left-[425px] overflow-clip right-[647px] top-[calc(50%-163.5px)]" data-name="SVG">
      <div className="absolute inset-[12.5%_29.17%_45.83%_29.17%]" data-name="Vector">
        <div className="absolute inset-[-10%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
            <path d={svgPaths.pa2c5b80} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[54.17%_16.67%_12.5%_16.67%]" data-name="Vector">
        <div className="absolute inset-[-12.5%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 5">
            <path d={svgPaths.p283a2180} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
    </div>
...
function Svg1() {
  return (
    <div className="absolute left-[12px] size-[12px] top-[6px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_1_4508)" id="SVG">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M6 4V6" id="Vector_2" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M6 8H6.005" id="Vector_3" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
...
function OverlayBorder() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#ffedca] border border-[#ffa600] border-solid h-[26px] left-[883px] rounded-[33554400px] top-[calc(50%-176.5px)] w-[112.02px]" data-name="Overlay+Border">
      <Svg1 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[31.35px] not-italic text-[#e86400] text-[11px] top-[12.09px] w-[66.87px]">
        <p className="leading-[16.5px]">1 mandatory</p>
      </div>
    </div>
  );
}
...
function Svg2() {
  return (
    <div className="-translate-y-1/2 absolute left-[1032px] size-[16px] top-[calc(50%-176.5px)]" data-name="SVG">
...
function ProjectData() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[423px] left-[32px] right-[32px] rounded-[14px] top-[426px]" data-name="Project data">
      <Background />
      <div className="-translate-y-1/2 absolute flex flex-col font-normal justify-center leading-[0] left-[68px] not-italic right-[870px] text-[#1c1d1f] text-[0px] top-[calc(50%-183.5px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Alex Morgan</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[171px] not-italic right-[819px] text-[#737373] text-[12px] top-[calc(50%-182.5px)] whitespace-nowrap">
        <p className="leading-[16px]">Project Manager</p>
      </div>
      <Background1 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[298px] not-italic right-[762px] text-[#17171a] text-[0px] top-[calc(50%-163px)] whitespace-nowrap">
        <p className="font-bold leading-[16.5px] text-[11px]">25%</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[349px] not-italic right-[688px] text-[#17171a] text-[11px] top-[calc(50%-163px)] whitespace-nowrap">
        <p className="leading-[16.5px]">1/4 tasks</p>
      </div>
      <Svg />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[440px] not-italic right-[627px] text-[#17171a] text-[11px] top-[calc(50%-163px)] whitespace-nowrap">
        <p className="leading-[16.5px]">1/4</p>
      </div>
      <OverlayBorder />
      <Svg2 />
    </div>
...
function CheckIcon() {
  return (
    <div className="-translate-y-1/2 absolute left-[16px] size-[20px] top-[calc(50%-0.25px)]" data-name="Check Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_4427)" id="Check Icon">
          <path d={svgPaths.p17cc7980} id="Vector" stroke="var(--stroke-0, #34AC86)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3fe63d80} id="Vector_2" stroke="var(--stroke-0, #34AC86)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
...
function RequiredChip() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[23px] left-[257px] right-[727px] rounded-[8px] top-[calc(50%-9px)]" data-name="Required Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[8.62px] not-italic text-[#0072ff] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Required</p>
      </div>
    </div>
  );
}
...
function Svg3() {
  return (
    <div className="-translate-y-1/2 absolute left-[7.62px] size-[12px] top-[calc(50%-0.25px)]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="SVG">
          <path d={svgPaths.pcbdc080} id="Vector" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p146a1b00} id="Vector_2" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function UserChip() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[23px] left-[335px] right-[657px] rounded-[8px] top-[calc(50%-9px)]" data-name="User Chip">
      <Svg3 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[23.24px] not-italic text-[#26957a] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">User</p>
      </div>
    </div>
  );
}
...
function CompletedChip() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[26.5px] left-[867px] rounded-[33554400px] top-[calc(50%-0.25px)] w-[74.92px]" data-name="Completed Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[10px] not-italic text-[#26957a] text-[10px] top-[12.5px] tracking-[0.2px] whitespace-nowrap">
...
function ArrowRightIcon() {
  return (
    <div className="-translate-y-1/2 absolute left-[969.92px] size-[16px] top-[calc(50%-0.25px)]" data-name="Arrow Right Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Arrow Right Icon">
          <g id="Vector">
            <path d="M6 12L10 8L6 4" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M6 12L10 8L6 4" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M6 12L10 8L6 4" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
      </svg>
    </div>
...
function DeleteIcon() {
  return (
    <div className="-translate-y-1/2 absolute left-[1009.92px] size-[16px] top-[calc(50%-0.25px)]" data-name="Delete Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Delete Icon">
          <path d="M6.66667 7.33333V11.3333" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M9.33333 7.33333V11.3333" id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p37e28100} id="Vector_3" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M2 4H14" id="Vector_4" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2ffbeb80} id="Vector_5" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function MobilizationData() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[67px] left-[16px] right-[17px] rounded-[10px] top-[12px]" data-name="Mobilization Data">
      <CheckIcon />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[720px] text-[#737373] text-[0px] top-[calc(50%-9.25px)] whitespace-nowrap">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid font-bold leading-[20px] line-through text-[14px]">Read Project Documentation</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[944px] text-[#1c1d1f] text-[11px] top-[calc(50%+12.5px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Orientation</p>
      </div>
      <RequiredChip />
      <UserChip />
      <CompletedChip />
...
function UncheckIcon() {
  return (
    <div className="absolute inset-[calc(33.96%-0.32px)_calc(96.48%+0.93px)_calc(36.19%-0.28px)_calc(1.62%-0.97px)]" data-name="Uncheck Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_4435)" id="Uncheck Icon">
          <path d={svgPaths.p14d24500} id="Vector" stroke="var(--stroke-0, #7B6B58)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="1.66667" />
        </g>
        <defs>
...
function RequiredChip1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[23px] left-[238px] right-[746px] rounded-[8px] top-[calc(50%-9px)]" data-name="Required Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[8.62px] not-italic text-[#0072ff] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Required</p>
      </div>
    </div>
...
function UserChip1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[23px] left-[316px] right-[676px] rounded-[8px] top-[calc(50%-9px)]" data-name="User Chip">
      <Svg4 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[23.24px] not-italic text-[#26957a] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">User</p>
      </div>
...
function CompletedChip1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#f3f4f6] border border-[#d9d9d9] border-solid h-[27px] left-[851px] rounded-[33554400px] top-1/2 w-[91px]" data-name="Completed Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[11px] not-italic text-[#b4b4b4] text-[10px] top-[12.5px] tracking-[0.2px] whitespace-nowrap">
        <p className="leading-[15px]">Not Complete</p>
      </div>
    </div>
  );
}

function ArrowRightIcon1() {
  return (
    <div className="-translate-y-1/2 absolute left-[969.92px] size-[16px] top-[calc(50%-0.25px)]" data-name="Arrow Right Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Arrow Right Icon">
...
function MobilizationData1() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[67px] left-[16px] right-[17px] rounded-[10px] top-[84px]" data-name="Mobilization Data">
      <UncheckIcon />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[825px] text-[#17171a] text-[0px] top-[calc(50%-9.25px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Schedule Kickoff Meeting</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[944px] text-[#1c1d1f] text-[11px] top-[calc(50%+12.5px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Orientation</p>
      </div>
...
function RequiredChip2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[23px] left-[352px] right-[632px] rounded-[8px] top-[calc(50%-9px)]" data-name="Required Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[8.62px] not-italic text-[#0072ff] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Required</p>
      </div>
    </div>
...
function UserChip2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[23px] left-[430px] right-[562px] rounded-[8px] top-[calc(50%-9px)]" data-name="User Chip">
      <Svg5 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[23.24px] not-italic text-[#26957a] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">User</p>
      </div>
...
function MobilizationData2() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[67px] left-[16px] right-[17px] rounded-[10px] top-[156px]" data-name="Mobilization Data">
      <UncheckIcon1 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[714px] text-[#17171a] text-[0px] top-[calc(50%-9.25px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Create Shared Google Drive Project Folder</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[944px] text-[#1c1d1f] text-[11px] top-[calc(50%+12.5px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Orientation</p>
      </div>
...
function RequiredChip3() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[23px] left-[282px] right-[702px] rounded-[8px] top-[calc(50%-9px)]" data-name="Required Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[8.62px] not-italic text-[#0072ff] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Required</p>
      </div>
    </div>
...
function UserChip3() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[23px] left-[360px] right-[632px] rounded-[8px] top-[calc(50%-9px)]" data-name="User Chip">
      <Svg6 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[23.24px] not-italic text-[#26957a] text-[11px] top-[calc(50%+0.25px)] whitespace-nowrap">
        <p className="leading-[16.5px]">User</p>
      </div>
...
function MobilizationData3() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[67px] left-[16px] right-[17px] rounded-[10px] top-[228px]" data-name="Mobilization Data">
      <UncheckIcon2 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[786px] text-[#17171a] text-[0px] top-[calc(50%-9.25px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Request access to current CMS</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[48px] not-italic right-[944px] text-[#1c1d1f] text-[11px] top-[calc(50%+12.5px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Orientation</p>
      </div>
...
function Svg7() {
  return (
    <div className="-translate-y-1/2 absolute left-0 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <g id="Vector">
...
function AddTasksBtn() {
  return (
    <div className="absolute h-[20px] left-[16px] top-[314px] w-[76.33px]" data-name="Add tasks btn">
      <Svg7 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+10.83px)] not-italic text-[#17171a] text-[13px] text-center top-1/2 whitespace-nowrap">
...
function ActivityData() {
  return (
    <div className="absolute border-[#d5e1ff] border-solid border-t h-[353px] left-[32px] right-[32px] top-[495px]" data-name="Activity data">
      <MobilizationData />
      <MobilizationData1 />
      <MobilizationData2 />
      <MobilizationData3 />
...
function MobilizationTable() {
  return (
    <div className="absolute contents left-[32px] right-[32px] top-[426px]" data-name="Mobilization Table">
      <ProjectData />
      <ActivityData />
    </div>
  );
...
function Background2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#ffc300] left-[16px] rounded-[33554400px] size-[40px] top-[calc(50%-176.5px)]" data-name="Background">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[14px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[14px] text-center text-white top-1/2 w-[9.54px]">
...
function Background3() {
  return <div className="-translate-y-1/2 absolute bg-[#d9d9d9] h-[6px] left-[68px] right-[798px] rounded-[33554400px] top-[calc(50%-163.5px)]" data-name="Background" />;
}
...
function OverlayBorder1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#ffedca] border border-[#ffa600] border-solid h-[26px] left-[883px] rounded-[33554400px] top-[calc(50%-176.5px)] w-[112.02px]" data-name="Overlay+Border">
      <Svg9 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[31.35px] not-italic text-[#e86400] text-[11px] top-[12.09px] w-[66.87px]">
        <p className="leading-[16.5px]">3 mandatory</p>
      </div>
    </div>
  );
}
...
function ProjectData1() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[423px] left-[32px] right-[32px] rounded-[14px] top-[864px]" data-name="Project data">
      <Background2 />
      <div className="-translate-y-1/2 absolute flex flex-col font-normal justify-center leading-[0] left-[68px] not-italic right-[870px] text-[#1c1d1f] text-[0px] top-[calc(50%-183.5px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Daniel Wong</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[171px] not-italic right-[855px] text-[#737373] text-[12px] top-[calc(50%-182.5px)] whitespace-nowrap">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[349px] not-italic right-[688px] text-[#17171a] text-[11px] top-[calc(50%-163px)] whitespace-nowrap">
        <p className="leading-[16.5px]">1/3 tasks</p>
      </div>
      <Svg8 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[440px] not-italic right-[626px] text-[#17171a] text-[11px] top-[calc(50%-163px)] whitespace-nowrap">
        <p className="leading-[16.5px]">2/4</p>
      </div>
      <OverlayBorder1 />
      <Svg10 />
    </div>
...
function ActivityData1() {
  return (
    <div className="absolute border-[#d5e1ff] border-solid border-t h-[353px] left-[32px] right-[32px] top-[933px]" data-name="Activity data">
      <MobilizationData4 />
      <MobilizationData5 />
      <MobilizationData6 />
      <MobilizationData7 />
...
function MobilizationTable1() {
  return (
    <div className="absolute contents left-[32px] right-[32px] top-[864px]" data-name="Mobilization Table">
      <ProjectData1 />
      <ActivityData1 />
    </div>
  );
...
function Svg16() {
  return (
    <div className="-translate-y-1/2 absolute left-[1067px] size-[16px] top-[calc(50%+0.5px)]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M4 6L8 10L12 6" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
...
function Svg17() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p3159e300} id="Vector" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M5.33333 6.66667V9.33333" id="Vector_2" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 6.66667V8" id="Vector_3" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6667 6.66667V10.6667" id="Vector_4" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Overlay() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] left-[16px] rounded-[8px] size-[36px] top-[calc(50%+0.5px)]" data-name="Overlay">
      <Svg17 />
    </div>
  );
}
...
function Svg18() {
  return (
    <div className="-translate-y-1/2 absolute h-[12px] left-[318px] overflow-clip right-[785px] top-[calc(50%-11.5px)]" data-name="SVG">
      <div className="absolute inset-[62.5%_33.33%_12.5%_8.33%]" data-name="Vector">
        <div className="absolute inset-[-16.67%_-6.59%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.58333 4">
            <path d={svgPaths.p22d9cd00} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[13.03%_20.85%_54.7%_66.67%]" data-name="Vector">
        <div className="absolute inset-[-12.92%_-30.81%_-12.92%_-30.82%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.62306 4.87223">
            <path d={svgPaths.p858c00} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[63.04%_8.33%_12.5%_79.17%]" data-name="Vector">
        <div className="absolute inset-[-17.04%_-30.77%_-17.04%_-30.78%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.62511 3.93511">
            <path d={svgPaths.p2d2b7f80} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[12.5%_45.83%_54.17%_20.83%]" data-name="Vector">
        <div className="absolute inset-[-12.5%_-11.54%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33333 5">
            <path d={svgPaths.pda06d00} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
    </div>
...
function Background4() {
  return (
    <div className="-translate-y-1/2 absolute bg-[#d9d9d9] h-[6px] left-[64px] overflow-clip right-[769px] rounded-[33554400px] top-[calc(50%+14.5px)]" data-name="Background">
      <div className="absolute bottom-0 left-0 right-3/4 rounded-[33554400px] top-0" style={{ backgroundImage: "linear-gradient(124.703deg, rgb(67, 141, 253) 12.682%, rgb(90, 117, 255) 69.195%, rgb(115, 0, 255) 107.47%)" }} data-name="Background" />
    </div>
  );
}
...
function Title() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border-[#438dfd] border-l-4 border-solid h-[69px] left-[32px] right-[32px] rounded-tl-[10px] rounded-tr-[10px] top-[342px]" data-name="Title">
      <Svg16 />
      <Overlay />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic right-[885px] text-[#17171a] text-[0px] top-[calc(50%-11.5px)] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[14px]">Northstar Brand Refresh</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[242px] not-italic right-[827px] text-[#737373] text-[11px] top-[calc(50%-11px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Branding</p>
      </div>
      <Svg18 />
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[364px] not-italic right-[601px] text-[#3170ad] text-[0px] top-[calc(50%+14.5px)] whitespace-nowrap">
        <p className="text-[12px]">
          <span className="leading-[16px]">{`25% complete `}</span>
          <span className="leading-[16px] text-[#737373]">—</span>
          <span className="leading-[16px]">{` 1/4 tasks`}</span>
        </p>
      </div>
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-[#3170ad] h-[32px] left-[4px] rounded-[8px] top-[4px] w-[111.59px]" data-name="Button">
      <Svg19 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+11.21px)] not-italic text-[13px] text-center text-white top-1/2 whitespace-nowrap">
        <p className="leading-[20px]">By Project</p>
      </div>
    </div>
  );
}
...
function Svg20() {
  return (
    <div className="-translate-y-1/2 absolute left-[12px] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p32887f80} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1a837050} id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1f197700} id="Vector_3" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3694d280} id="Vector_4" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute h-[32px] left-[115.59px] rounded-[8px] top-[4px] w-[127.83px]" data-name="Button">
      <Svg20 />
...
function ProjectMembersToggle() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[42px] left-[32px] right-[calc(75%+14.58px)] rounded-[10px] top-[280px]" data-name="Project/Members Toggle">
      <Button />
      <Button1 />
    </div>
  );
...
function Container() {
  return (
    <div className="absolute h-[17px] left-[36px] overflow-clip right-[12px] top-[8.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[14px] justify-center leading-[0] left-0 not-italic text-[#737373] text-[13.2px] top-[8px] w-[108.75px]">
...
function Svg21() {
  return (
    <div className="absolute h-[16px] left-[11.42px] overflow-clip right-[243.58px] top-[9px]" data-name="SVG">
      <div className="absolute inset-[69.42%_12.5%_12.5%_69.42%]" data-name="Vector">
        <div className="absolute inset-[-23.04%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.22667 4.22667">
            <path d="M3.56 3.56L0.666667 0.666667" id="Vector" stroke="var(--stroke-0, #58637B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[12.5%_20.83%_20.83%_12.5%]" data-name="Vector">
        <div className="absolute inset-[-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
            <path d={svgPaths.p1b38bb40} id="Vector" stroke="var(--stroke-0, #58637B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
    </div>
...
function SearchBar() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[36px] left-[289.42px] overflow-clip right-[calc(50%+29.58px)] rounded-[8px] top-[283px]" data-name="Search Bar">
      <Container />
      <Svg21 />
    </div>
  );
...
function Svg22() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p32887f80} id="Vector" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1a837050} id="Vector_2" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1f197700} id="Vector_3" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3694d280} id="Vector_4" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Overlay1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(255,166,0,0.2)] left-[16px] rounded-[33554400px] size-[36px] top-1/2" data-name="Overlay">
      <Svg22 />
    </div>
  );
}
...
function MembersCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[32px] right-[calc(75%-1px)] rounded-[14px] top-[183px]" data-name="Members Card">
      <Overlay1 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[24px] justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[24px] top-[calc(50%-10px)] w-[26.9px]">
...
function Svg23() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_4460)" id="SVG">
          <path d={svgPaths.p39ee6532} id="Vector" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p17134c00} id="Vector_2" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Overlay2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] left-[16px] rounded-[33554400px] size-[36px] top-1/2" data-name="Overlay">
      <Svg23 />
    </div>
  );
}
...
function TaskDoneCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[calc(25%+21px)] right-[calc(50%+10px)] rounded-[14px] top-[183px]" data-name="Task Done Card">
      <Overlay2 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[24px] top-[calc(50%-10px)] whitespace-nowrap">
        <p className="leading-[24px]">22/77</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[12px] top-[calc(50%+14px)] whitespace-nowrap">
        <p className="leading-[16px]">Tasks Done</p>
      </div>
    </div>
  );
}
...
function Svg24() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_4442)" id="SVG">
          <path d={svgPaths.p39ee6532} id="Vector" stroke="var(--stroke-0, #C92A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 5.33333V8" id="Vector_2" stroke="var(--stroke-0, #C92A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 10.6667H8.00667" id="Vector_3" stroke="var(--stroke-0, #C92A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Overlay3() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(223,34,37,0.1)] left-[16px] rounded-[33554400px] size-[36px] top-1/2" data-name="Overlay">
      <Svg24 />
    </div>
  );
}
...
function OverdueCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[calc(50%+10px)] right-[calc(25%+21px)] rounded-[14px] top-[183px]" data-name="Overdue Card">
      <Overlay3 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[24px] justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[24px] top-[calc(50%-10px)] w-[13.56px]">
        <p className="leading-[24px]">0</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic text-[#c92a2a] text-[12px] top-[calc(50%+14px)] whitespace-nowrap">
...
function Svg25() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p37f49070} id="Vector" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Overlay4() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] left-[16px] rounded-[33554400px] size-[36px] top-1/2" data-name="Overlay">
      <Svg25 />
    </div>
  );
}

function MendatoryPendingCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[calc(75%-1px)] right-[32px] rounded-[14px] top-[183px]" data-name="Mendatory Pending Card">
      <Overlay4 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[24px] top-[calc(50%-10px)] whitespace-nowrap">
        <p className="leading-[24px]">33</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic text-[#17171a] text-[12px] top-[calc(50%+14px)] whitespace-nowrap">
        <p className="leading-[16px]">Mandatory Pending</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-white h-[36px] left-[4px] rounded-[8px] top-[4px] w-[105.14px]" data-name="Button">
      <div className="absolute bg-[#3170ad] inset-0 rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Button:shadow" />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+0.43px)] not-italic text-[13px] text-center text-white top-1/2 whitespace-nowrap">
        <p className="leading-[20px]">Onboarding</p>
      </div>
    </div>
  );
}

function OnOffBoardingToggle() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[46px] left-[32px] rounded-[10px] top-[115px] w-[220.28px]" data-name="On/Off boarding toggle">
      <Button2 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[163px] not-italic text-[#6e6f71] text-[13px] text-center top-[22px] whitespace-nowrap">
        <p className="leading-[20px]">Offboarding</p>
      </div>
    </div>
  );
}
...
function TemplatesBtn() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[38px] left-[calc(75%+150px)] right-[32.33px] rounded-[8px] top-[48px]" data-name="Templates btn">
      <Svg26 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+11.17px)] not-italic text-[#17171a] text-[13.5px] text-center top-1/2 whitespace-nowrap">
...
function Heading() {
  return (
    <div className="absolute contents left-[32px] right-[32.33px] top-[32px]" data-name="Heading">
      <TemplatesBtn />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[32px] not-italic right-[calc(75%-20px)] text-[#1c1d1f] text-[0px] top-[50px] tracking-[-0.5px] whitespace-nowrap">
        <p className="font-bold leading-[normal] text-[30px]">Project Mobilization</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[32px] not-italic right-[calc(50%+227px)] text-[#3170ad] text-[14px] top-[80.5px] whitespace-nowrap">
        <p className="leading-[normal]">Check your projects status here - Placeholder text</p>
      </div>
    </div>
  );
}
...
function Main() {
  return (
    <div className="absolute bg-[#f5fbff] h-[948px] left-[256px] right-[-48px] top-[81px]" data-name="Main">
      <BackgroundBorder />
      <MobilizationTable />
      <MobilizationTable1 />
      <Title />
      <ProjectMembersToggle />
      <SearchBar />
      <MembersCard />
      <TaskDoneCard />
      <OverdueCard />
      <MendatoryPendingCard />
      <OnOffBoardingToggle />
      <Heading />
    </div>
  );
...
function Svg33() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.pcbc4a80} id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p32566c00} id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p25e54000} id="Vector_3" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2a9e6140} id="Vector_4" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      ...
      <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Project Mobilization">
        <Svg33 />
        <Container7 />
      </div>
    </div>
...
export default function V207Mobilization() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 07 mobilization">
      <Main />
