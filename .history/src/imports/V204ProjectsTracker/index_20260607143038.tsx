...
function Button() {
    return (
        <div
            className="absolute bg-white border border-[#d5e1ff] border-solid h-[40px] left-[816px] rounded-[10px] top-[14px] w-[71.84px]"
            data-name="Button"
        >
            <Svg />
        ...
        >
            ...
            <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-px not-italic text-[#3170ad] text-[14px] top-[50px] whitespace-nowrap">
                <p className="leading-[20px]">
                    Check your projects status here - Placeholder text
                </p>
            </div>
            <Button />
            <Button1 />
...
function HorizontalScrollBar() {
    return (
        <div
            className="absolute h-[0.5px] left-[1.5px] top-[451.5px] w-[1100px]"
            data-name="horizontal scroll bar"
        >
            <div className="absolute inset-[-500%_-0.23%]">
                <svg
                    ...
                    fill="none"
                    preserveAspectRatio="none"
                    viewBox="0 0 1105 5.5"
                >
                    <g id="horizontal scroll bar">
                        <path
                            d="M2.5 2.5L1102.5 2.5"
                            id="Line 3"
