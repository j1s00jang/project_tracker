      ...
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_1_2884)" id="SVG">
          ...
          <g id="Vector_2">
            ...
            <path d="M8.75 2.91667L11.0833 5.25" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.16667" />
            <path d="M8.75 2.91667L11.0833 5.25" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.16667" />
          </g>
        </g>
        <defs>
...
function Button() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[40px] left-[816px] rounded-[10px] top-[14px] w-[71.84px]" data-name="Button">
      <Svg />
...
function Button1() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[40px] left-[896px] rounded-[10px] top-[14px] w-[224px]" data-name="Button">
  ...
  return (
    <div className="absolute h-[60px] left-[31px] right-[691px] top-[31px]" data-name="Header">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[18px] tracking-[-0.5px] whitespace-nowrap">
        <p className="leading-[normal] text-[30px]">Projects Tracker</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-px not-italic text-[#3170ad] text-[14px] top-[50px] whitespace-nowrap">
        <p className="leading-[20px]">Check your projects status here - Placeholder text</p>
      </div>
      <Button />
      <Button1 />
    </div>
...
function Svg2() {
  return (
    <div className="-translate-y-1/2 absolute left-[133.62px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
...
function ViewTasks() {
  return (
    <div className="absolute h-[20px] left-[950px] right-[20px] top-[60px]" data-name="View Tasks">
...
function Project() {
  return (
    <div className="absolute border border-[#d5e1ff] border-solid h-[126px] left-[31px] right-[716px] rounded-[18px] top-[113px]" style={{ backgroundImage: "linear-gradient(117.587deg, rgba(67, 141, 253, 0.13) 12.682%, rgba(90, 117, 255, 0.13) 69.195%, rgba(115, 0, 255, 0.13) 107.47%)" }} data-name="Project">
      <ProjectIcon />
      <CurrentTracking />
      <Progress />
      <ViewTasks />
...
function Svg3() {
  return (
    <div className="-translate-y-1/2 absolute left-[10px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
          <g id="Vector">
...
function Svg4() {
  return (
    <div className="-translate-y-1/2 absolute left-[119px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
...
function AllPhases() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[36px] left-[31px] right-[1693px] rounded-[10px] top-[266px]" data-name="All Phases">
      <Svg3 />
...
function Svg5() {
  return (
    <div className="-translate-y-1/2 absolute left-[89px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
          <path d="M3.5 5.25L7 8.75L10.5 5.25" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
...
function AllTypes() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[36px] left-[185px] right-[1568px] rounded-[10px] top-[266px]" data-name="All Types">
...
function Svg6() {
  return (
    <div className="-translate-y-1/2 absolute left-[105.57px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
          <path d="M3.5 5.25L7 8.75L10.5 5.25" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
...
function AllStatues() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[36px] left-[310px] right-[1427px] rounded-[10px] top-[266px]" data-name="All Statues">
...
function Svg7() {
  return (
    <div className="-translate-y-1/2 absolute left-[122px] size-[14px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="SVG">
          <path d="M3.5 5.25L7 8.75L10.5 5.25" id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
...
function Sort() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[36px] left-[451px] right-[1269px] rounded-[10px] top-[266px]" data-name="Sort">
...
function TableHeader() {
  return (
    <div className="[word-break:break-word] absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid font-bold h-[40px] leading-[0] left-0 not-italic rounded-tl-[10px] rounded-tr-[10px] text-[11px] top-0 tracking-[1px] uppercase w-[1807px] whitespace-nowrap" data-name="Table Header">
...
function Status() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[26px] left-[1038px] opacity-80 right-[689px] rounded-[8px] top-[12px]" data-name="Status">
      <Svg8 />
...
function TasksRow() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[50px] w-[1807px]" data-name="Tasks Row">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[626px] not-italic right-[1127px] text-[#5803cf] text-[0px] top-[25.5px] whitespace-nowrap">
        <p className="font-bold leading-[16.5px] text-[11px]">+ Jesse Li</p>
      </div>
...
function Status1() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[26px] left-[1038px] right-[650.28px] rounded-[8px] top-[12px]" data-name="Status">
      <Svg9 />
...
function TasksRow1() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[350px] w-[1807px]" data-name="Tasks Row">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[21px] not-italic right-[1779px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
        <p className="leading-[20px]">1</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic right-[1694px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
...
function TasksRow2() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[100px] w-[1807px]" data-name="Tasks Row">
...
function TasksRow3() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[400px] w-[1807px]" data-name="Tasks Row">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[21px] not-italic right-[1778px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
        <p className="leading-[20px]">2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[64px] not-italic right-[1694px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
...
function TasksRow4() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[150px] w-[1807px]" data-name="Tasks Row">
...
function TasksRow5() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[200px] w-[1807px]" data-name="Tasks Row">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[21px] not-italic right-[1777px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
...
function TasksRow6() {
  return (
    <div className="absolute border-[#d5e1ff] border-b border-solid h-[50px] left-[-1px] top-[250px] w-[1807px]" data-name="Tasks Row">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[21px] not-italic right-[1778px] text-[#17171a] text-[13px] top-[25px] whitespace-nowrap">
...
function DataSvg() {
  return (
    <div className="-translate-y-1/2 absolute h-[16px] left-[16px] overflow-clip right-[1775px] top-[calc(50%+1px)]" data-name="Data → SVG">
...
function Data() {
  return (
    <div className="[word-break:break-word] absolute h-[20px] leading-[0] left-[64px] not-italic right-[1041.48px] top-[16px] whitespace-nowrap" data-name="Data">
      <div className="-translate-y-1/2 absolute flex flex-col font-normal justify-center left-0 text-[#17171a] text-[0px] top-[calc(50%+0.5px)]">
        <p className="font-bold leading-[20px] text-[13px]">Initiation</p>
      </div>
...
function Status7() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[26px] left-[1038px] opacity-80 right-[689px] rounded-[8px] top-[13px]" data-name="Status">
      <Svg21 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[28px] not-italic text-[#3170ad] text-[11px] top-[calc(50%+0.5px)] whitespace-nowrap">
        <p className="leading-[16.5px]">Started</p>
      </div>
...
function ProjectTasksTableRow() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border-[#d5e1ff] border-b border-solid h-[51px] left-[-1px] top-[-1px] w-[1807px]" data-name="Project Tasks Table Row">
      <DataSvg />
      <Data />
      <Status7 />
...
function ProjectTasksTableRow1() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border-[#d5e1ff] border-b border-solid h-[51px] left-[-1px] top-[299px] w-[1807px]" data-name="Project Tasks Table Row">
      <DataSvg1 />
      <Data1 />
      <Status8 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[1189px] not-italic right-[553px] text-[#737373] text-[11px] top-[26.5px] whitespace-nowrap">
...
function HorizontalScrollBar() {
  return (
    <div className="absolute h-[0.5px] left-[1.5px] top-[451.5px] w-[1100px]" data-name="horizontal scroll bar">
      <div className="absolute inset-[-500%_-0.23%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1105 5.5">
          <g id="horizontal scroll bar">
            <path d="M2.5 2.5L1102.5 2.5" id="Line 3" stroke="var(--stroke-0, #F3F4F6)" strokeLinecap="round" strokeWidth="5" />
            <path d="M2.84483 3H288.362" id="Line 4" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeWidth="5" />
          </g>
        </svg>
      </div>
    </div>
...
function Body() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[455px] left-0 top-[39px] w-[1807px]" data-name="Body">
      <TasksRow />
      <TasksRow1 />
      <TasksRow2 />
      <TasksRow3 />
...
function Table() {
  return (
    <div className="absolute bg-white h-[499px] left-[31px] overflow-x-auto rounded-tl-[20px] rounded-tr-[20px] top-[319px]" data-name="Table">
      <div className="relative h-[499px] w-[1807px]" data-name="Table Inner">
        <TableHeader />
        <Body />
      </div>
    </div>
...
function Main() {
  return (
    <div className="absolute inset-[81px_-684px_-1px_256px]" data-name="Main">
      <Header />
      <Project />
      <AllPhases />
      <AllTypes />
...
function Svg26() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M8.66667 3.33333H14" id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8.66667 8H14" id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8.66667 12.6667H14" id="Vector_3" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p245c7a00} id="Vector_4" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.pbb5d900} id="Vector_5" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      ...
      <div className="content-stretch flex gap-[12px] h-[36px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Projects Tracker">
        <Svg26 />
        <Container5 />
      </div>
...
function Grid() {
  return <div className="absolute h-[944px] left-[255px] top-[80px] w-[1185px]" data-name="grid" />;
}

export default function V204ProjectsTracker() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 04 projects tracker">
      <div className="absolute bg-white h-[943px] left-[255px] top-[80px] w-[1869px]" data-name="extended bg - white" />
      <div className="absolute bg-[#f5fbff] h-[943px] left-[255px] top-[80px] w-[1869px]" data-name="extended bg - blue" />
      <Main />
