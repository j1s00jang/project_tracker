...
// Projects Tracker: pin header, currently-tracking card, and filter row
const PROJECTS_TRACKER_FIXED_TOP_HEIGHT = 81 + 266 + 36 - NAV_TOP;

// Members Calendar: pin header, toolbar, and utilization legend above the data table
...
const MEMBERS_SEARCH_SUGGESTIONS: readonly SearchSuggestion[] = [
  { icon: "👤", label: "Alex Morgan", type: "Member" },
  { icon: "👤", label: "Daniel Wong", type: "Member" },
  { icon: "👤", label: "Michelle Chen", type: "Member" },
  { icon: "👤", label: "Sarah Chen", type: "Member" },
  { icon: "👤", label: "Bryan Johnson", type: "Member" },
  { icon: "👤", label: "Julie Kim", type: "Member" },
  { icon: "👤", label: "Andy Smith", type: "Member" },
  { icon: "👤", label: "Jason Liu", type: "Member" },
  { icon: "👤", label: "Jessi Li", type: "Member" },
  { icon: "👤", label: "Priya Shah", type: "Member" },
];
...
const TRACKER_HEADER_BTN_GAP = 8;
...
function TasksTrackerViewProjectsLink({ onNavigate }: { onNavigate: () => void }) {
  return (
    <button
      type="button"
      aria-label="View Projects Tracker"
      onClick={(event) => {
        event.stopPropagation();
        onNavigate();
      }}
...
export default function App() {
  ...
  const scrollHeight = SCROLL_HEIGHTS[page];
      ...
      {page === "membersCalendar" && (
        <div
          ...
          style={{
            ...
            top: NAV_TOP,
            right: 0,
            height: MEMBERS_CALENDAR_FIXED_TOP_HEIGHT,
            overflow: "hidden",
            background: "#f5fbff",
            zIndex: 12,
          }}
