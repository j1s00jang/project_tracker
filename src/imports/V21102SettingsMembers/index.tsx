import svgPaths from "./svg-mejp8uvjnc";
...
function Button() {
  return (
    <div className="absolute h-[46px] left-[8px] rounded-[10px] top-[8px] w-[545px]" data-name="Button">
      <Svg />
...
function Button1() {
  return (
    <div className="absolute h-[46px] left-[565px] rounded-[14px] top-[8px] w-[545px]" data-name="Button">
      <Button2 />
      <Svg1 />
