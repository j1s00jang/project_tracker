import svgPaths from "./svg-wl1sjupnl0";

function ButtonEditSvg() {
  return (
    <div className="absolute left-[1780px] size-[16px] top-[22px]" data-name="Button - Edit → SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_2453)" id="Button - Edit â SVG">
          <g id="Vector">
            <path d={svgPaths.p1ba32a00} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p1ba32a00} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p1ba32a00} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_2">
            <path d="M10 3.33333L12.6667 6" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M10 3.33333L12.6667 6" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M10 3.33333L12.6667 6" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
        <defs>
...
function ButtonDeleteSvg() {
  return (
    <div className="absolute left-[1812px] size-[16px] top-[22px]" data-name="Button - Delete → SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function TemplatesCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[100px] left-[32px] right-[32px] rounded-[10px] top-[248px]" data-name="Templates Card">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[13.5px] top-[26px] whitespace-nowrap">
        <p className="leading-[20px]">Client Contract Agreement Template</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[10.9px] top-[46px] whitespace-nowrap">
        <p className="leading-[16px]">External Contract</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[20px] not-italic text-[#3170ad] text-[11.6px] top-[74px] w-[42.84px]">
        <p className="leading-[16px]">General</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[78.64px] not-italic text-[#17171a] text-[11.3px] top-[74px] w-[48.87px]">
        <p className="leading-[16px]">2 phases</p>
      </div>
      <ButtonEditSvg />
      <ButtonDeleteSvg />
    </div>
...
function TemplatesCard1() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[100px] left-[32px] right-[32px] rounded-[10px] top-[360px]" data-name="Templates Card">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[20px] justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[13.6px] top-[26px] w-[150.68px]">
        <p className="leading-[20px]">Sample WBS Template</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[11.4px] top-[46px] w-[81.45px]">
        <p className="leading-[16px]">WBS Template</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[20px] not-italic text-[#3170ad] text-[11.1px] top-[74px] w-[47.84px]">
        <p className="leading-[16px]">Software</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[83.64px] not-italic text-[#17171a] text-[11.1px] top-[74px] w-[48.87px]">
        <p className="leading-[16px]">4 phases</p>
      </div>
      <ButtonEditSvg1 />
      <ButtonDeleteSvg1 />
    </div>
...
function TemplatesCard2() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[100px] left-[32px] right-[32px] rounded-[10px] top-[472px]" data-name="Templates Card">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold h-[20px] justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[13.6px] top-[26px] w-[345.08px]">
        <p className="leading-[20px]">{`UX Flow & User Flow Template`}</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[20px] not-italic text-[#17171a] text-[11.4px] top-[46px] w-[129.98px]">
        <p className="leading-[16px]">UX, User Flow</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[20px] not-italic text-[#3170ad] text-[11.1px] top-[74px] w-[47.84px]">
        <p className="leading-[16px]">Design</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[83.64px] not-italic text-[#17171a] text-[11.1px] top-[74px] w-[48.87px]">
        <p className="leading-[16px]">3 phases</p>
      </div>
      <ButtonEditSvg2 />
      <ButtonDeleteSvg2 />
    </div>
...
function NewBtn() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[32px] px-[16px] py-[10px] right-[calc(75%+83.75px)] rounded-[10px] top-[192px]" data-name="New btn">
      ...
      <div className="[word-break:break-word] flex flex-col font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">New WBS Template</p>
      </div>
    </div>
  );
}

function WbsTemplatesTab() {
  return (
    <div className="absolute bg-[#3170ad] content-stretch drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] flex items-center justify-center left-[4px] px-[17px] py-[8px] rounded-[8px] top-[4px]" data-name="WBS Templates Tab">
      <div className="[word-break:break-word] flex flex-col font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">WBS Templates</p>
      </div>
    </div>
  );
}
...
function Onboarding() {
  return (
    <div className="absolute content-stretch drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] flex items-center justify-center left-[142px] px-[17px] py-[8px] rounded-[8px] top-[4px]" data-name="Onboarding">
      <div className="[word-break:break-word] flex flex-col font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#b4b4b4] text-[13px] text-center whitespace-nowrap">
        <p className="leading-[20px]">Project Onboarding Templates</p>
      </div>
    </div>
  );
}
...
function Offboarding() {
  return (
    <div className="absolute content-stretch drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] flex items-center justify-center left-[371px] px-[17px] py-[8px] rounded-[8px] top-[4px]" data-name="Offboarding">
      <div className="[word-break:break-word] flex flex-col font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#b4b4b4] text-[13px] text-center whitespace-nowrap">
        <p className="leading-[20px]">Project Offboarding Templates</p>
      </div>
    </div>
  );
}
...
function ToggleTabs() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[46px] left-[32px] rounded-[10px] top-[122px] w-[602px]" data-name="Toggle Tabs">
      <WbsTemplatesTab />
      <Onboarding />
      <Offboarding />
    </div>
...
function Header() {
  return (
    <div className="[word-break:break-word] absolute contents leading-[0] left-[32px] not-italic right-[calc(50%+226.5px)] top-[32px] whitespace-nowrap" data-name="Header">
      <div className="-translate-y-1/2 absolute flex flex-col font-bold justify-center left-[32px] right-[calc(75%+6.75px)] text-[#17171a] text-[0px] top-[50px] tracking-[-0.5px]">
        <p className="leading-[normal] text-[30px]">Templates Library</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-normal justify-center left-[32px] right-[calc(50%+226.5px)] text-[#3170ad] text-[14px] top-[81px]">
        <p className="leading-[20px]">Browse WBS, onboarding, and offboarding templates</p>
      </div>
    </div>
  );
}
...
function Main() {
  return (
    <div className="absolute bg-[#f5fbff] h-[942px] left-[256px] overflow-clip top-[81px] w-[1183px]" data-name="Main">
      <div className="absolute h-[942px] left-0 top-0 w-[1183px]" />
      <TemplatesCard />
      <TemplatesCard1 />
      <TemplatesCard2 />
      <NewBtn />
...
function Svg3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p118e9580} id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p36cdaf00} id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p21ad0600} id="Vector_3" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      ...
      <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Templates">
        <Svg3 />
        <Container2 />
      </div>
...
export default function V203Templates() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 03 templates">
      <Main />
