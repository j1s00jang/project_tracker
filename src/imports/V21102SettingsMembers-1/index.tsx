import svgPaths from "./svg-locg56b80o";

function Svg() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-110.5px)] size-[16px] top-1/2" data-name="SVG">
...
function Button() {
  return (
    <div className="absolute h-[46px] left-[8px] rounded-[10px] top-[8px] w-[545px]" data-name="Tab-PMs">
      <Svg />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+12px)] not-italic text-[#737373] text-[13px] text-center top-1/2 whitespace-nowrap">
        <p className="leading-[20px]">Project Managers and Team Leads</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[46px] left-0 rounded-[10px] top-0 w-[545px]" data-name="Button" />;
}
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-51.5px)] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <g id="Vector">
            <path d={svgPaths.p1c647980} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p1c647980} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p1c647980} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_2">
            <path d={svgPaths.p13d22180} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p13d22180} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p13d22180} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
      </svg>
    </div>
...
function Container() {
  return (
    <div className="-translate-y-1/2 absolute h-[17px] left-[12px] overflow-auto right-[575px] top-[calc(50%+0.5px)]" data-name="Container">
...
function Svg2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+507.5px)] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function Developers() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] right-[32px] rounded-[10px] top-[56px]" data-name="Developers">
      <Container />
      <Svg2 />
    </div>
  );
...
function Developers1() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] right-[32px] rounded-[10px] top-[112px]" data-name="Developers">
      <Container1 />
      <Svg3 />
    </div>
  );
...
function Developers2() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] right-[32px] rounded-[10px] top-[168px]" data-name="Developers">
      <Container2 />
      <Svg4 />
    </div>
  );
...
function Developers3() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] right-[32px] rounded-[10px] top-[224px]" data-name="Developers">
      <Container3 />
      <Svg5 />
    </div>
  );
...
function Container4() {
  return (
    <div className="-translate-y-1/2 absolute h-[17px] left-[12px] overflow-auto right-[575px] top-[calc(50%+0.5px)]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">Business Analyst</p>
      </div>
    </div>
  );
}
...
function Developers4() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] right-[32px] rounded-[10px] top-[280px]" data-name="Developers">
      <Container4 />
      <Svg6 />
    </div>
  );
...
function Button3() {
  return (
    <div className="absolute h-[20px] left-[31px] right-[calc(75%+174.66px)] top-[348px]" data-name="Button">
      <Svg7 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[calc(50%+15.83px)] not-italic text-[#0072ff] text-[14px] text-center top-[calc(50%+0.5px)] whitespace-nowrap">
        <p className="leading-[normal]">Add Role</p>
      </div>
    </div>
  );
}
...
export default function V21102SettingsMembers() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 11.02. settings / Members">
      <Overlay />
