import svgPaths from "./svg-iq9v82aiv3";
  ...
  return (
    <div className="-translate-y-1/2 absolute left-[12px] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <g id="Vector">
            <path d={svgPaths.p36bb6c80} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p36bb6c80} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p36bb6c80} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
      </svg>
    </div>
...
function Svg2() {
  return (
    <div className="-translate-y-1/2 absolute left-[81.84px] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <g id="Vector">
            <path d="M4 6L8 10L12 6" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M4 6L8 10L12 6" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M4 6L8 10L12 6" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
      </svg>
    </div>
...
function FilterDropdown() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[40px] left-[calc(25%+35.75px)] right-[calc(50%+148.5px)] rounded-[10px] top-[113px]" data-name="Filter Dropdown">
      <Svg1 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[14px] justify-center leading-[0] left-[calc(50%+0.02px)] not-italic text-[#17171a] text-[13px] text-center top-1/2 w-[38.04px]">
...
function Svg3() {
  return (
    <div className="absolute h-[16px] left-[11px] overflow-clip right-[259px] top-[11px]" data-name="SVG">
...
function SearchBar() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[40px] left-[32px] overflow-clip right-[calc(50%+272.5px)] rounded-[10px] top-[113px]" data-name="Search Bar">
      <Container />
      <Svg3 />
    </div>
  );
...
function ProfileIcon() {
  return (
    <div className="absolute bg-[#14b2a4] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">A</p>
      </div>
    </div>
  );
}
...
function FullName() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Alex Morgan</p>
      </div>
    </div>
  );
}
...
function Role() {
  return (
    <div className="absolute h-[20px] left-[83px] overflow-clip right-[174px] top-[44px]" data-name="Role">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#6e6f71] text-[13px] top-[10px] whitespace-nowrap">
...
function Capacity() {
  return (
    <div className="absolute border-[#d5e1ff] border-solid border-t h-[33px] left-[22px] right-[22px] top-[80px]" data-name="Capacity">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#737373] text-[0px] top-[22px] whitespace-nowrap">
        <p className="text-[13px]">
          <span className="leading-[20px]">{`Capacity: `}</span>
          <span className="leading-[20px] text-[#17171a]">40h/week</span>
        </p>
      </div>
    </div>
  );
...
function ContractStatusChip() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[26px] left-[22px] right-[189px] rounded-[8px] top-[132px]" data-name="Contract Status Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[17px] not-italic text-[#0072ff] text-[11.4px] top-1/2 w-[114.65px]">
        <p className="leading-[16px]">Permanent Employee</p>
      </div>
    </div>
  );
}
...
function Svg4() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_4933)" id="SVG">
          <path d={svgPaths.p1ba32a00} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10 3.33333L12.6667 6" id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function EditBtn() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[32px] left-[262px] right-[63px] rounded-[8px] top-[129px]" data-name="Edit btn">
      <Svg4 />
    </div>
  );
}
...
function Svg5() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p90824c0} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M12 11.3333V6" id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8.66667 11.3333V3.33333" id="Vector_3" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M5.33333 11.3333V9.33333" id="Vector_4" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function StatBtn() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[32px] left-[303px] right-[22px] rounded-[8px] top-[129px]" data-name="Stat btn">
      <Svg5 />
    </div>
  );
}
...
function MemberInfoCard() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[32px] right-[calc(50%+198.5px)] rounded-[18px] top-[176px]" data-name="Member Info Card">
      <ProfileIcon />
      <FullName />
      <Role />
      <Capacity />
...
function ProfileIcon1() {
  return (
    <div className="absolute bg-[#ffc300] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">D</p>
      </div>
    </div>
  );
}
...
function FullName1() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Daniel Wong</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard1() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[32px] right-[calc(50%+198.5px)] rounded-[18px] top-[382px]" data-name="Member Info Card">
      <ProfileIcon1 />
      <FullName1 />
      <Role1 />
      <Capacity1 />
...
function ProfileIcon2() {
  return (
    <div className="absolute bg-[#009557] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">D</p>
      </div>
    </div>
...
function FullName2() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Michelle Chen</p>
      </div>
    </div>
  );
}
...
function Role2() {
  return (
    <div className="absolute h-[20px] left-[83px] overflow-clip right-[174px] top-[44px]" data-name="Role">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#6e6f71] text-[13px] top-[10px] whitespace-nowrap">
        <p className="leading-[20px]">Team Lead</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard2() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(25%+115.75px)] right-[calc(25%+114.75px)] rounded-[18px] top-[588px]" data-name="Member Info Card">
      <ProfileIcon2 />
      <FullName2 />
      <Role2 />
      <Capacity2 />
...
function ProfileIcon3() {
  return (
    <div className="absolute bg-[#ff5a28] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">S</p>
      </div>
    </div>
  );
}
...
function FullName3() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Sarah Chen</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard3() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(50%+198.5px)] right-[32px] rounded-[18px] top-[588px]" data-name="Member Info Card">
      <ProfileIcon3 />
      <FullName3 />
      <Role3 />
      <Capacity3 />
...
function ProfileIcon4() {
  return (
    <div className="absolute bg-[#eb0000] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">B</p>
      </div>
    </div>
  );
}
...
function FullName4() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Bryan Johnson</p>
      </div>
    </div>
  );
}
...
function Role4() {
  return (
    <div className="absolute h-[20px] left-[83px] overflow-clip right-[174px] top-[44px]" data-name="Role">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#6e6f71] text-[13px] top-[10px] whitespace-nowrap">
        <p className="leading-[20px]">Consultant</p>
      </div>
    </div>
  );
}
...
function ContractStatusChip4() {
  return (
    <div className="absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[26px] left-[22px] right-[254px] rounded-[8px] top-[132px]" data-name="Contract Status Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[17px] not-italic text-[#26957a] text-[11.4px] top-1/2 whitespace-nowrap">
        <p className="leading-[16px]">Contract</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard4() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(50%+198.5px)] right-[32px] rounded-[18px] top-[176px]" data-name="Member Info Card">
      <ProfileIcon4 />
      <FullName4 />
      <Role4 />
      <Capacity4 />
...
function ProfileIcon5() {
  return (
    <div className="absolute bg-[#ff84c0] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
...
function FullName5() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Julie Kim</p>
      </div>
    </div>
  );
}
...
function ContractStatusChip5() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#0072ff] border-solid h-[26px] left-[22px] right-[190px] rounded-[8px] top-[132px]" data-name="Contract Status Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[12px] justify-center leading-[0] left-[17px] not-italic text-[#0072ff] text-[11.4px] top-1/2 w-[114.65px]">
        <p className="leading-[16px]">Permanent Employee</p>
      </div>
    </div>
...
function MemberInfoCard5() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[32px] right-[calc(50%+198.5px)] rounded-[18px] top-[588px]" data-name="Member Info Card">
      <ProfileIcon5 />
      <FullName5 />
      <Role5 />
      <Capacity5 />
...
function ProfileIcon6() {
  return (
    <div className="absolute bg-[#ff7f16] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.6px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">A</p>
      </div>
    </div>
  );
...
function FullName6() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Andy Smith</p>
      </div>
    </div>
  );
}
...
function ContractStatusChip6() {
  return (
    <div className="absolute bg-[rgba(64,232,191,0.2)] border border-[#26957a] border-solid h-[26px] left-[22px] right-[253px] rounded-[8px] top-[132px]" data-name="Contract Status Chip">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[17px] not-italic text-[#26957a] text-[11.4px] top-1/2 whitespace-nowrap">
        <p className="leading-[16px]">Contract</p>
      </div>
    </div>
...
function MemberInfoCard6() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(25%+115.75px)] right-[calc(25%+115.75px)] rounded-[18px] top-[176px]" data-name="Member Info Card">
      <ProfileIcon6 />
      <FullName6 />
      <Role6 />
      <Capacity6 />
...
function ProfileIcon7() {
  return (
    <div className="absolute bg-[#3170ad] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.6px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">J</p>
      </div>
    </div>
...
function FullName7() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Jason Liu</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard7() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(25%+115.75px)] right-[calc(25%+115.75px)] rounded-[18px] top-[382px]" data-name="Member Info Card">
      <ProfileIcon7 />
      <FullName7 />
      <Role7 />
      <Capacity7 />
...
function ProfileIcon8() {
  return (
    <div className="absolute bg-[#0072ff] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.6px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">J</p>
      </div>
    </div>
...
function FullName8() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Jessi Li</p>
      </div>
    </div>
  );
}
...
function Role8() {
  return (
    <div className="absolute h-[20px] left-[83px] overflow-clip right-[174px] top-[44px]" data-name="Role">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#6e6f71] text-[13px] top-[10px] whitespace-nowrap">
        <p className="leading-[20px]">UI/UX Designer</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard8() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[calc(50%+199.5px)] right-[32px] rounded-[18px] top-[382px]" data-name="Member Info Card">
      <ProfileIcon8 />
      <FullName8 />
      <Role8 />
      <Capacity8 />
...
function ProfileIcon9() {
  return (
    <div className="absolute bg-[#8000c0] h-[44px] left-[22px] right-[294px] rounded-[33554400px] top-[20px]" data-name="Profile Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[calc(50%+0.6px)] not-italic text-[0px] text-center text-white top-1/2 w-[11.76px]">
        <p className="font-bold leading-[20px] text-[16px]">P</p>
      </div>
    </div>
  );
}
...
function FullName9() {
  return (
    <div className="absolute h-[24px] left-[83px] overflow-clip right-[115px] top-[20px]" data-name="Full name">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#1c1d1f] text-[0px] top-[12px] whitespace-nowrap">
        <p className="font-bold leading-[20px] text-[16px]">Priya Shah</p>
      </div>
    </div>
  );
}
...
function MemberInfoCard9() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[183px] left-[32px] right-[calc(50%+199.5px)] rounded-[18px] top-[794px]" data-name="Member Info Card">
      <ProfileIcon9 />
      <FullName9 />
      <Role9 />
      <Capacity9 />
...
function Main() {
  return (
    <div className="absolute bg-[#f5fbff] h-[944px] left-[256px] right-[-1px] top-[81px]" data-name="Main">
      <Header />
      <AddMemberBtn />
      <FilterDropdown />
      <SearchBar />
...
function Svg31() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p32887f80} id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1a837050} id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1f197700} id="Vector_3" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3694d280} id="Vector_4" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Project Members">
        <Svg31 />
        <Container8 />
      </div>
...
export default function V208Members() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 08 members">
      <Main />
