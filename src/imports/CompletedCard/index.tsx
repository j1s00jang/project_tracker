import svgPaths from "./svg-m3qyyg7eyd";
...
export default function CompletedCard() {
  return (
    <div className="bg-white border border-[#d5e1ff] border-solid relative rounded-[18px] size-full" data-name="Completed Card" style={{ transition: "transform 0.2s ease, box-shadow 0.2s ease" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(49,112,173,0.12)"; }} onMouseLeave={e => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = ""; }}>
      <Icon />
      <Container />
      <Container1 />
      <Container2 />
