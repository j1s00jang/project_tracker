import svgPaths from "./svg-tru4jewwdh";

function Header() {
  return (
    <div className="[word-break:break-word] absolute h-[64px] leading-[0] left-[32px] not-italic right-[32px] top-[32px]" data-name="Header">
      <div className="-translate-y-1/2 absolute flex flex-col font-bold h-[36px] justify-center left-0 right-[836px] text-[#17171a] text-[0px] top-[18px] tracking-[-0.5px]">
        <p className="leading-[normal] text-[30px]">Data Upload</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-normal h-[20px] justify-center left-0 right-[761.5px] text-[#3170ad] text-[14px] top-[49px]">
        <p className="leading-[20px]">Import and upload project data and resources</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p232b1d80} id="Vector" stroke="var(--stroke-0, #5803CF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #5803CF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #5803CF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #5803CF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #5803CF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Overlay() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(124,92,255,0.12)] left-[20px] rounded-[14px] size-[44px] top-1/2" data-name="Overlay">
      <Svg />
    </div>
  );
}
  ...
  return (
    <div className="-translate-y-1/2 absolute h-[20px] left-[80px] overflow-clip right-[56px] top-[calc(50%+12px)]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#737373] text-[12px] top-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Import project records including name, PM, dates, budget and status.</p>
      </div>
    </div>
  );
}
...
function Svg1() {
  return (
    <div className="-translate-y-1/2 absolute left-[1080px] size-[20px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
...
function Button() {
  return (
    <div className="absolute h-[76px] left-0 right-0 top-0" data-name="Button">
      <Overlay />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[24px] justify-center leading-[0] left-[80px] not-italic right-[976.74px] text-[#17171a] text-[0px] top-[calc(50%-10px)]">
        <p className="font-bold leading-[20px] text-[14px]">Projects</p>
      </div>
      <Container />
      <Svg1 />
    </div>
...
function Projects() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[32px] right-[32px] rounded-[18px] top-[113px]" data-name="Projects">
      <div className="absolute bg-white inset-[-1px] rounded-[18px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Overlay+Shadow" />
      <Button />
    </div>
  );
}
...
function Svg2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p232b1d80} id="Vector" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #26957A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Overlay1() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(64,232,191,0.2)] left-[20px] rounded-[14px] size-[44px] top-1/2" data-name="Overlay">
      <Svg2 />
    </div>
  );
}
...
function Members() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[32px] right-[32px] rounded-[18px] top-[203px]" data-name="Members">
      <div className="absolute bg-white inset-[-1px] rounded-[18px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Overlay+Shadow" />
      <Button1 />
    </div>
  );
...
function Svg4() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p232b1d80} id="Vector" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Overlay2() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(0,114,255,0.1)] left-[20px] rounded-[14px] size-[44px] top-1/2" data-name="Overlay">
      <Svg4 />
    </div>
  );
}
...
function Container2() {
  return (
    <div className="-translate-y-1/2 absolute h-[20px] left-[80px] overflow-clip right-[56px] top-[calc(50%+12px)]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#737373] text-[12px] top-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Import WBS structure items (Phases, Work Packages, Activities, Deliverables).</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute h-[76px] left-0 right-0 top-0" data-name="Button">
      <Overlay2 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[24px] justify-center leading-[0] left-[80px] not-italic right-[956.53px] text-[#17171a] text-[0px] top-[calc(50%-10px)]">
        <p className="font-bold leading-[20px] text-[14px]">WBS Items</p>
      </div>
      <Container2 />
      <Svg5 />
    </div>
...
function WbsItems() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[32px] right-[32px] rounded-[18px] top-[293px]" data-name="WBS Items">
      <div className="absolute bg-white inset-[-1px] rounded-[18px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Overlay+Shadow" />
      <Button2 />
    </div>
  );
...
function Svg6() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p232b1d80} id="Vector" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #FFA600)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Overlay3() {
  return (
    <div className="-translate-y-1/2 absolute bg-[rgba(255,166,0,0.2)] left-[20px] rounded-[14px] size-[44px] top-1/2" data-name="Overlay">
      <Svg6 />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="-translate-y-1/2 absolute h-[20px] left-[80px] overflow-clip right-[56px] top-[calc(50%+12px)]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#737373] text-[12px] top-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Import resource-to-project allocations with capacity percentages and date ranges.</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute h-[76px] left-0 right-0 top-0" data-name="Button">
      <Overlay3 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[24px] justify-center leading-[0] left-[80px] not-italic right-[876.02px] text-[#17171a] text-[0px] top-[calc(50%-10px)]">
        <p className="font-bold leading-[20px] text-[14px]">Resource Allocations</p>
      </div>
      <Container3 />
      <Svg7 />
    </div>
...
function Resource() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[78px] left-[32px] right-[32px] rounded-[18px] top-[383px]" data-name="Resource">
      <div className="absolute bg-white inset-[-1px] rounded-[18px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Overlay+Shadow" />
      <Button3 />
    </div>
  );
...
function Main() {
  return (
    <div className="absolute bg-[#f5fbff] h-[944px] left-[256px] right-[-2px] top-[81px]" data-name="Main">
      <Header />
      <Projects />
      <Members />
      <WbsItems />
...
function Svg17() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M8 2V10" id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p26e09a00} id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p23ad1400} id="Vector_3" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Data Upload">
        <Svg17 />
        <Container13 />
      </div>
...
export default function V210DataUpload() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 10 data upload">
      <Main />
