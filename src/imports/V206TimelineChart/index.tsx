...
function Container3() {
  return <TaskRowLabel left={70} label="Project Setup" />;
}
...
function Container4() {
  return <TaskRowLabel left={88} label="Project Charter" />;
}
...
function Container5() {
  return <TaskRowLabel left={106} label="Draft Charter" style="activity" />;
}
...
function Container6() {
  return <TaskRowLabel left={106} label="Review Charter" style="activity" />;
}
...
function Container7() {
  return <TaskRowLabel left={106} label="Approve Charter" style="activity" />;
}
...
function Container8() {
  return <TaskRowLabel left={52} label="Planning" />;
}
...
function Container9() {
  return <TaskRowLabel left={70} label="Requirement Gathering" />;
}
...
function Container10() {
  return <TaskRowLabel left={88} label="Requirement Document" style="deliverable" />;
}
...
function Container11() {
  return <TaskRowLabel left={106} label="Stakeholder Interviews" style="activity" />;
}
...
function Container12() {
  return <TaskRowLabel left={106} label="Documentation" style="activity" />;
}
