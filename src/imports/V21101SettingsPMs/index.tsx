import svgPaths from "./svg-q8yls8myku";

function Svg() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-58.5px)] size-[16px] top-1/2" data-name="SVG">
...
function Button() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.1)] border border-[#d5e1ff] border-solid h-[46px] left-[8px] rounded-[10px] top-[8px] w-[545px]" data-name="Tab-PMs">
      <Svg />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+11.5px)] not-italic text-[#17171a] text-[13px] text-center top-1/2 whitespace-nowrap">
        <p className="leading-[20px]">Project Managers</p>
      </div>
    </div>
  );
}
...
function Svg1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-51.5px)] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p1c647980} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p13d22180} id="Vector_2" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute h-[46px] left-[565px] rounded-[14px] top-[8px] w-[545px]" data-name="Tab-Members">
      <Svg1 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+11.5px)] not-italic text-[#737373] text-[13px] text-center top-1/2 whitespace-nowrap">
...
function PmMembersRoleTab() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[64px] left-[33px] right-[32px] rounded-[10px] top-[114px]" data-name="PM/Members Role Tab">
      <Button />
      <Button1 />
    </div>
  );
...
function Container() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
...
function Input() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] overflow-clip right-[calc(50%+36px)] rounded-[10px] top-[56px]" data-name="Input">
      <Container />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">alex.morgan@gooddesign.ca</p>
      </div>
    </div>
  );
}
...
function Input1() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(25%+258px)] overflow-clip right-[89px] rounded-[10px] top-[56px]" data-name="Input">
      <Container1 />
    </div>
  );
}
...
function Svg2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Button - Delete â SVG">
          <g id="Vector">
            <path d="M6.66667 7.33333V11.3333" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M6.66667 7.33333V11.3333" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M6.66667 7.33333V11.3333" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_2">
            <path d="M9.33333 7.33333V11.3333" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M9.33333 7.33333V11.3333" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M9.33333 7.33333V11.3333" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_3">
            <path d={svgPaths.p37e28100} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p37e28100} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p37e28100} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_4">
            <path d="M2 4H14" stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M2 4H14" stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d="M2 4H14" stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
          <g id="Vector_5">
            <path d={svgPaths.p2ffbeb80} stroke="var(--stroke-0, #242429)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p2ffbeb80} stroke="var(--stroke-1, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
            <path d={svgPaths.p2ffbeb80} stroke="var(--stroke-2, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="1.33333" />
          </g>
        </g>
      </svg>
    </div>
...
function ButtonRemove() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(75%+204px)] right-[32px] rounded-[10px] top-[56px]" data-name="Button - Remove">
      <Svg2 />
    </div>
  );
}
...
function Input2() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] overflow-clip right-[calc(50%+36px)] rounded-[10px] top-[112px]" data-name="Input">
      <Container2 />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">julie.kim@gooddesign.ca</p>
      </div>
    </div>
  );
}
...
function Input3() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(25%+258px)] overflow-clip right-[89px] rounded-[10px] top-[112px]" data-name="Input">
      <Container3 />
    </div>
  );
}
...
function ButtonRemove1() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(75%+205px)] right-[31px] rounded-[10px] top-[112px]" data-name="Button - Remove">
      <Svg3 />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">Michelle Chen</p>
      </div>
    </div>
  );
}
...
function Input4() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] overflow-clip right-[calc(50%+36px)] rounded-[10px] top-[168px]" data-name="Input">
      <Container4 />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">michelle.chen@gooddesign.ca</p>
      </div>
    </div>
  );
}
...
function Input5() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(25%+258px)] overflow-clip right-[89px] rounded-[10px] top-[168px]" data-name="Input">
      <Container5 />
    </div>
  );
}
...
function ButtonRemove2() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(75%+205px)] right-[31px] rounded-[10px] top-[168px]" data-name="Button - Remove">
      <Svg4 />
    </div>
  );
}
...
function Input6() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] overflow-clip right-[calc(50%+36px)] rounded-[10px] top-[224px]" data-name="Input">
      <Container6 />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">sarah.chen@gooddesign.ca</p>
      </div>
    </div>
  );
}
...
function Input7() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(25%+258px)] overflow-clip right-[89px] rounded-[10px] top-[224px]" data-name="Input">
      <Container7 />
    </div>
  );
}
...
function ButtonRemove3() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(75%+205px)] right-[31px] rounded-[10px] top-[224px]" data-name="Button - Remove">
      <Svg5 />
    </div>
  );
}
...
function Input8() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[31px] overflow-clip right-[calc(50%+36px)] rounded-[10px] top-[280px]" data-name="Input">
      <Container8 />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute h-[17px] left-[12px] overflow-auto right-[12px] top-[12.5px]" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-0 not-italic text-[#17171a] text-[14px] top-[8px] whitespace-nowrap">
        <p className="leading-[20px]">priya.shah@gooddesign.ca</p>
      </div>
    </div>
  );
}
...
function Input9() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(25%+258px)] overflow-clip right-[89px] rounded-[10px] top-[280px]" data-name="Input">
      <Container9 />
    </div>
  );
}
...
function ButtonRemove4() {
  return (
    <div className="absolute bg-[rgba(0,114,255,0.04)] border border-[#d5e1ff] border-solid h-[44px] left-[calc(75%+205px)] right-[31px] rounded-[10px] top-[280px]" data-name="Button - Remove">
      <Svg6 />
    </div>
  );
}
...
function Svg7() {
  return (
    <div className="-translate-y-1/2 absolute left-0 size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M3.33333 8H12.6667" id="Vector" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M8 3.33333V12.6667" id="Vector_2" stroke="var(--stroke-0, #0072FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="absolute h-[20px] left-[31px] right-[calc(75%+174.66px)] top-[348px]" data-name="Button">
      <Svg7 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[calc(50%+11.33px)] not-italic text-[#0072ff] text-[14px] text-center top-[calc(50%+0.5px)] whitespace-nowrap">
        <p className="leading-[normal]">Add PM</p>
      </div>
    </div>
  );
}
...
function Svg8() {
  return (
    <div className="-translate-y-1/2 absolute left-[15.25px] size-[16px] top-1/2" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
...
function SaveBtn() {
  return (
    <div className="absolute bg-[#3170ad] h-[36px] left-[calc(75%+161.75px)] right-[31px] rounded-[10px] top-[340px]" data-name="Save btn">
      <div className="absolute inset-0 rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" data-name="Button:shadow" />
      <Svg8 />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-medium justify-center leading-[0] left-[calc(50%+10.63px)] not-italic text-[13.5px] text-center text-white top-1/2 whitespace-nowrap">
...
function Data() {
  return (
    <div className="absolute bg-white border border-[#d5e1ff] border-solid h-[398px] left-[32px] right-[32px] rounded-[10px] top-[228px]" data-name="Data">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[31px] not-italic right-[calc(50%+42px)] text-[#17171a] text-[14px] top-[30px] whitespace-nowrap">
        <p className="leading-[20px]">Add project managers and team leads with their name and email address.</p>
      </div>
      <Input />
      <Input1 />
      <ButtonRemove />
...
function Overlay() {
  return (
    <div className="absolute bg-[#f5fbff] h-[945px] left-[256px] right-[-2px] top-[81px]" data-name="Overlay">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-bold justify-center leading-[0] left-[33px] not-italic right-[calc(75%+77.5px)] text-[#17171a] text-[0px] top-[50px] tracking-[-0.5px] whitespace-nowrap">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal justify-center leading-[0] left-[32px] not-italic right-[calc(50%+228px)] text-[#3170ad] text-[14px] top-[81px] whitespace-nowrap">
        <p className="leading-[20px]">Manage PMs available for project assignment</p>
      </div>
      <PmMembersRoleTab />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-normal h-[16px] justify-center leading-[0] left-[32px] not-italic right-[calc(50%+271px)] text-[#737373] text-[0px] top-[208px]">
        <p className="font-bold leading-[16px] text-[12px]">PMs AVAILABLE FOR PROJECT ASSIGNMENT</p>
      </div>
      <Data />
    </div>
  );
...
function Svg19() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p1e124b00} id="Vector" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p28db2b80} id="Vector_2" stroke="var(--stroke-0, #0033D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Tabs2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Tabs">
      ...
      <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[10px] shrink-0 w-[231px]" style={{ backgroundImage: "linear-gradient(110.649deg, rgba(67, 141, 253, 0.15) 12.682%, rgba(90, 117, 255, 0.15) 69.195%, rgba(115, 0, 255, 0.15) 107.47%)" }} data-name="Configuration">
        <Svg19 />
        <Container20 />
      </div>
    </div>
...
export default function V21101SettingsPMs() {
  return (
    <div className="bg-white relative size-full" data-name="v2 - 11.01. settings - PMs">
      <Overlay />
